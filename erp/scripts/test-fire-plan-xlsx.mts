...
console.log('\n[3] 백지 불변식 — 템플릿에 표본의 답이 남아 있지 않은가')
{
  ...
  // 2026-09-18(4): 1.14.2 홍보방법 2칸으로 21→23 — promoLog 앞 두 건이 덮는다
  check('법정예시문칸 예외 수가 그대로(… + 1.11.2 3 + 1.14.2 2)',
    sampleCells.length === 23, sampleCells.map(a => `${a.sheet}!${a.cell}`).join(' · '))
  ...
  // 2026-09-18: 2.6·2.9·2.10·2.11 대상명 4칸으로 4→8 · 1.5.2 대상명으로 8→9
  check('접두라벨칸 예외 수가 그대로(대상명 8 + 1.10.1 사용승인일 = 9칸)', prefixCells.length === 9,

...
check('배선된 값 슬롯 ≥ 208', wired >= 208, `${wired}칸 (${(wired / slots * 100).toFixed(1)}%)`)
check('배선된 상자 ≥ 96', wiredBoxes >= 96, `${wiredBoxes}칸 (${(wiredBoxes / boxes * 100).toFixed(1)}%)`)

...
check('배선된 값 슬롯 ≥ 265', wired >= 265, `${wired}칸 (${(wired / slots * 100).toFixed(1)}%)`)
check('배선된 상자 ≥ 209', wiredBoxes >= 209, `${wiredBoxes}칸 (${(wiredBoxes / boxes * 100).toFixed(1)}%)`)

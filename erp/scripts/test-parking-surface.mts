...
/* ────────────────────────────────────────────────────────────────────────────
 * [8] 전기차충전소 — 서식 1.1 `AR13` (2026-09-16 신설)
 *
 * 법정 양식이 **주차장 13행 안**에 둔 셋째 칸이라(`L13 옥내`·`AB13 옥외`·`AR13 전기차충전소`)
...
console.log('\n[8] 전기차충전소 — 1.1 AR13 (2026-09-16)')
{
  ...
  check('좌표가 1.1의 AR13이다', a.length === 1 && a[0].cell === 'AR13' && a[0].sheet.startsWith('1.1'))

// 마이그레이션 143 운영 적용 — notifications.type에 'law_revision' 추가
// 실행: node scripts/_apply-143-prod.mjs        (미리보기)
//       node scripts/_apply-143-prod.mjs --run  (적용, 토큰: %TEMP%/sbtok.txt)
//
...
console.log('마이그레이션 143 — notifications.type에 law_revision 추가 (운영)')

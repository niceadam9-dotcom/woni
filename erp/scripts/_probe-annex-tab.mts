...
//   ① 탭이 실재하고 순서가 **공통 → 보고서 → 소방계획서**인가 (nth 기반 셀렉터의 축 — 2026-09-20 사용자 지정 순서)
...
try {
  ...
  check('① 순서: 공통 → 보고서 → 소방계획서 (2026-09-20 사용자 지정)',
    iFac >= 0 && iAnnex === iFac + 1 && iPlan === iAnnex + 1,
    `fac=${iFac} annex=${iAnnex} plan=${iPlan}`)

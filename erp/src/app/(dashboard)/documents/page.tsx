  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-ink">문서함</h1>
          <p className="text-sm text-ink-sub mt-1">내가 기안한 문서 목록</p>
        </div>
        <Link
          href="/documents/new"
      ...
      {docs.length === 0 ? (
        <div className="bg-surface rounded-xl border border-line py-16 text-center">
          ...
          <p className="text-sm text-ink-sub">작성한 기안서가 없습니다</p>
          <Link href="/documents/new" className="mt-3 inline-block text-sm text-brand hover:underline">
            기안서 작성하기
          </Link>
        </div>
      ) : (

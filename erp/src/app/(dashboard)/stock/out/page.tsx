  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <PackageMinus className="size-6 text-brand" />
        <div><h1 className="text-xl font-bold text-ink">출고 등록</h1><p className="text-sm text-ink-sub mt-0.5">품목 출고 내역을 등록합니다</p></div>
      </div>
      <StockMovementClient

  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center gap-3">
        <Link
          href="/leaves"
          className="inline-flex items-center justify-center size-9 rounded-lg border border-line text-ink-sub hover:bg-paper transition-colors"
        >
          <ArrowLeft className="size-4" />
        </Link>
        <div>
          <h1 className="text-xl font-bold text-ink">휴가 신청</h1>
          <p className="text-sm text-ink-sub mt-0.5">휴가 신청서를 작성해주세요</p>
        </div>
      </div>

      <div className="bg-surface rounded-xl border border-line shadow-[rgba(18,43,165,0.08)_0px_1px_1px_-0.5px,rgba(18,43,165,0.08)_0px_3px_3px_-1.5px,rgba(18,43,165,0.08)_0px_6px_6px_-3px,rgba(18,43,165,0.08)_0px_12px_12px_-6px] p-6">

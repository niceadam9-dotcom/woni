      ...
      <div className="bg-surface rounded-2xl shadow-2xl w-full max-w-xl flex flex-col max-h-[88vh]">
          ...
          {done ? (
            ...
            <div className="space-y-3">
              ...
              {results.map(r => (
                ...
                >
                  <span className="font-medium text-ink">{year}년 {r.month}월</span>
                  {r.error
                        ...
                        return (
                          <label
                            ...
                            className={`flex items-center gap-3 px-3 py-2.5 rounded-xl border cursor-pointer transition-colors ${
                              on ? 'border-orange-300 bg-orange-50' : 'border-line hover:bg-paper'
                            }`}
                          >
                            <input
                              type="checkbox"
        ...
        <div className="px-6 py-4 border-t border-brand-line-soft flex gap-2 shrink-0">
          {done ? (
            <button
              onClick={onResolved}
              className="flex-1 py-2.5 text-sm bg-brand text-white rounded-lg font-medium hover:bg-brand-strong transition-colors"
            >
              완료 — 달력 새로고침
            </button>
          ) : (

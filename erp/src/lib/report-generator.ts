...
// 키 = 표준 코드(마이그레이션 100, src/lib/facility-codes.ts). 갑지 현황 시트는 축약 22종 배치라
// 계열 세분 코드(물분무 9종·제연 2종·유도등/유도표지·조기진압용)는 같은 셀로 합침.
// 신규 7종(단독경보형감지기·화재알림·통합감시·누전경보기·피난유도선·휴대용비상조명등·연소방지설비)은
// 갑지에 대응 셀이 없어 unmapped로 리포트됨(기존 동작).
const FACILITY_CHECKBOX: Record<string, string[]> = {
  ...
  '이산화탄소소화설비': ['C16'],
  '할론소화설비': ['C16'],
  '할로겐화합물 및 불활성기체소화설비': ['C16'],
  '분말소화설비': ['C16'],
  '강화액소화설비': ['C16'],
  '고체에어로졸소화설비': ['C16'],
  '옥외소화전설비': ['C25'],
  '자동화재탐지설비 및 시각경보기': ['C28'],
  '비상경보설비': ['C27'],
  '비상방송설비': ['C29'],
  '자동화재속보설비': ['C31'],
  '가스누설경보기': ['C33'],

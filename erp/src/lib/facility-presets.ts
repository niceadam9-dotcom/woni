...
const COMMON = ['소화기구 및 자동소화장치', '자동화재탐지설비 및 시각경보기', '유도등']

const SETS: Array<{ match: RegExp; label: string; items: string[] }> = [
  { match: /아파트|공동주택/, label: '공동주택형',
    items: [...COMMON, '옥내소화전설비', '스프링클러설비', '피난기구', '비상조명등', '비상방송설비'] },
  { match: /숙박|병원|의료|요양/, label: '숙박·의료형',
    items: [...COMMON, '옥내소화전설비', '스프링클러설비', '피난기구', '인명구조기구', '비상조명등', '비상방송설비', '자동화재속보설비'] },
  { match: /공장|창고/, label: '공장·창고형',
    items: [...COMMON, '옥내소화전설비', '옥외소화전설비', '비상경보설비'] },
  { match: /판매|근린|업무|교육/, label: '상가·업무형',
    items: [...COMMON, '옥내소화전설비', '비상조명등'] },
]
...
export const DETAIL_TYPE_PRESETS: Record<string, string[]> = {
  '소화기구 및 자동소화장치': ['분말', 'CO2', '강화액', '자동확산'],
  '옥내소화전설비': ['수량'],
  '옥외소화전설비': ['수량'],
  '스프링클러설비': ['헤드'],
  '간이스프링클러설비': ['헤드'],
  '자동화재탐지설비 및 시각경보기': ['감지기', '발신기', '수신기'],
  '유도등': ['피난구', '통로', '객석'],
  '유도표지': ['수량'],
  '비상조명등': ['수량'],
  '피난기구': ['완강기', '구조대', '피난사다리'],

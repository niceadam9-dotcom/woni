...
|----------|--------|-------------------|------|------|-----------------|
| 1 | **1단계: 점검 계획** | 점검 업무 | use_approval_date | +1일 | true (영업일) |
| 2 | **2단계: 배치확인서 보고서 작성** | (메뉴 없음) | use_approval_date | +5일 | true(영업일) |
| 3 | **3단계: 관계인 보고서 제출** | 보고서 제출현황 | use_approval_date| +10일 | true |
| 4 | **4단계: 소방서 보고서 제출 및 이행계획서 등록** | 이행계획서 등록 | use_approval_date | +15일 | true |
